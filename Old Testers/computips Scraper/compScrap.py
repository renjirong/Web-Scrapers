...
def noLink():
    ...
    if proceed != "Y" and proceed != "y":
        ...
        return input("Enter last known 'URL' from https://db.aa419.org/fakebankslist.php:" )
...
def main():
    lastLink = "News-ginetu.cc"
    linkList = []
    pageCtr = 1
    go = True
    link = "https://www.computips.org/category/removal-guides/adware/"
    page = "page/"
    nLink = False
    while go:
